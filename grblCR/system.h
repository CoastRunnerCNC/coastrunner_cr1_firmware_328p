...
// these are used by sys_rt_exec_state global
#define EXEC_STATUS_REPORT  bit(0) // bitmask 00000001
#define EXEC_CYCLE_START    bit(1) // bitmask 00000010
#define EXEC_CYCLE_STOP     bit(2) // bitmask 00000100
#define EXEC_FEED_HOLD      bit(3) // bitmask 00001000
#define EXEC_RESET          bit(4) // bitmask 00010000
//#define UNUSED    bit(5) // bitmask 00100000 //unused
...
typedef struct {
  ...
  uint8_t probe_interrupt_occurred; //added //logs when the probe interrupts.
  uint8_t report_ok_mode;      //added //stores how to display 'ok' response message (e.g. 'ok', '0k', '1k', etc)
